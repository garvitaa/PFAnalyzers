...
const int ETA_BINS = 20;
float etabins[ETA_BINS+1] =
 {-5.191, -4.013, -2.964, -2.5, -1.93, -1.566, -1.305, -0.957, -0.696, -0.435, 0,
  0.435, 0.696, 0.957, 1.305, 1.566, 1.93, 2.5, 2.964, 4.013, 5.191};
...
//  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 100 , 0. , 20. );
  ...
  hname = "match_ptfrac";
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 5000, 0. , 100.0 );   
  hname = "match_ptfrac5";
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 5000, 0. , 100.0 );
  hname = "match_ptfrac9";
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 5000, 0. , 100.0 );
...
// ....
  ...
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 5000 , 0. , 100. );
  ...
  hname = "EovP";
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 1000 , 0. , 5. );
  hname = "EovP_brem";
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 1000 , 0. , 5. );
  hname = "EovP_nobrem";
  m_Histos1D[hname] = fs->make<TH1F>(hname, hname , 1000 , 0. , 5. );
